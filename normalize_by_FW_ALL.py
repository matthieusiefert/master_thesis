...
# ─────────────────────────────────────────────────────────────────────────────
# 1. TABLE DES FW  →  clé : (genotype, replicate, tissue_code)
# ─────────────────────────────────────────────────────────────────────────────
FW_DATA = {
    # ── Young Leaf (YL) ──────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# 3. PARSING DES NOMS DE COLONNES
#    Format A : GAQ_02_GENOTYPE_REP_TISSUE_...   (ex: FRA_3_FLW_, UNG1_4_YR_)
#    Format B : GAQ_02_GENOTYPE_TISSUEn_...      (ex: EBB16_YL1_, SEI3_FLW2_)
# ─────────────────────────────────────────────────────────────────────────────
def parse_sample(col_name: str):
    """Retourne (genotype, replicate_int, tissue_code) ou (None, None, None)."""
    ...
    # Format B : GENOTYPE_TISSUEn (rep collé au code tissu)
...
if missing_fw:
    print(f"\n⚠ FW manquant pour : {', '.join(missing_fw)}")
    print("  → Ces colonnes seront NaN après normalisation.\n")
...
print(f"  Features normalisées : {len(df)}")
print(f"  Échantillons traités : {len(peak_cols)}")
